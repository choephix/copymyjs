...
export default function(container: HTMLElement) {
  ...
  const output1 = container.querySelector('#output1')!;
  ...
  container.querySelector('#emit1')?.addEventListener('click', () => {
    output1.innerHTML = '';
    multicaster1('Hello from priority multicaster!');
  });

  container.querySelector('#clear1')?.addEventListener('click', () => {
    multicaster1.clear();
    output1.innerHTML = '<div class="text-gray-400">All subscribers cleared</div>';
  });

  // Simple Multicaster Demo
  const output2 = container.querySelector('#output2')!;
  ...
  container.querySelector('#emit2')?.addEventListener('click', () => {
    output2.innerHTML = '';
    multicaster2('Hello from simple multicaster!');
  });

  container.querySelector('#clear2')?.addEventListener('click', () => {
    multicaster2.clear();
    output2.innerHTML = '<div class="text-gray-400">All subscribers cleared</div>';
  });

  // Ordered Multicaster Demo
  const output3 = container.querySelector('#output3')!;
  ...
  container.querySelector('#emit3')?.addEventListener('click', () => {
    output3.innerHTML = '';
    multicaster3('Hello from ordered multicaster!');
  });

  container.querySelector('#clear3')?.addEventListener('click', () => {
    multicaster3.clear();
